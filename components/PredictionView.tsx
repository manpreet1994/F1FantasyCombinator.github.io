...
const PredictionView: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-slate-800/50 rounded-lg shadow-lg min-h-[400px]">
      ...
      <h2 className="text-2xl font-bold text-slate-100 mb-2">AI Predictions Coming Soon!</h2>
